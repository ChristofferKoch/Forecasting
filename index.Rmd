...
1. [Introduction to Course](L01.Rmd)
...
2. [A Brief Introduction to SAS](L02.Rmd)
...
3. [Salient Characteristics of Time Series Data](L03.Rmd)
...
4. [Brief Interlude on the Detection of Seasonality, Trend, and Cycle](L04.Rmd)
...
5. [A Beginning Time Series Model: The Stable Seasonal Pattern Model](L05.Rmd)
...
6. [A First Generation Forecasting Model - The Deterministic Trend/Deterministic Seasonal (DTDS) Model](L06.Rmd)
...
7. [A Sophisticated Time Series Decomposition Model: The Unobserved Components Model](L07.Rmd) <!-- #  (Proc UCM in SAS) -->
...
8. [Some Important Concepts Leading up to Box-Jenkins Modeling](L08.Rmd)
...
9. [Box Jenkins Models for Stationary, Non-Seasonal Time Series](L09.Rmd)
...
10. [Box-Jenkins Models - Forecasting for Stationary, Non-Seasonal Time Series](L10.Rmd)
...
11. [Box-Jenkins Models for Non-Seasonal, Stochastically-Trending Time Series](L11.Rmd)
...
12. [Box-Jenkins Models for Seasonal, Stochastically-Trending Time Series](L12.Rmd)
...
13. [Exponential Smoothing - An Old Favorite](L13.Rmd) <!-- # (Proc ESM) -->
...
14. [Searching for an Extra Variable to Help Us Forecast: VARs](L14.Rmd) <!-- # (Proc VARMAX) -->
...
15. [Combining Forecasts](L15.Rmd)
...
* August 21: ~~Review of Course Outline and Focus of Course~~
* August 23: ~~Some Basic Concepts, Apps.smu, and Introduction to SAS~~
* August 28: Some Practice with SAS programming
* August 30: Salient Characteristics of Time Series Data
* September 4: Detection of Seasonality, Trend, and Cycle in Time Series Data
* September 6: Detection of Seasonality, Trend, and Cycle in Time Series Data continued.
* September 11: The Stable Seasonal Pattern Model
* September 13: The Stable Seasonal Pattern Model continued.
* September 18: Deterministic Trend/Deterministic Season Model
* September 20: Deterministic Trend/Deterministic Season Model continued.
* September 25: Unobserved Components Model
* September 27: Unobserved Components Model continued.
* October 2: Review for Mid-term I exam
* October 4: Mid-term I exam
* October 9: Fall Break
* October 11: Important Concepts Leading up to Box-Jenkins Modeling
* October 16: Important Concepts Leading up to Box-Jenkins Modeling continued.
* October 18: Box-Jenkins Modeling
* October 23: Box-Jenkins Modeling continued.
* October 25: Box-Jenkins Modeling continued.
* October 30: Box-Jenkins Modeling continued.
* November 1: Box-Jenkins Modeling continued.
* November 6: Exponential Smoothing
* November 8: Searching for an Extra Variable to Help us Forecast
* November 13: Searching for an Extra Variable to Help us Forecast continued.
* November 15: Searching for an Extra Variable to Help us Forecast continued.
* November 20: Combination Forecasting
* November 27: Review for Mid-term II exam
* November 29: Mid-term II exam
* Double-Point Homework in lieu of final exam due at 5:00 pm on Monday, December 4 in my office or mailbox.
